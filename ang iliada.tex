...
%START
\chapter{Ang Galit ni Achilles} %I
...
\pagebreak
\chapter{Ang Pagtitipon mga Hukbo} %II
...
\pagebreak
\chapter{Pagsusuri ni Helen ng mga Kampeon} %III
...
\pagebreak
\chapter{Gumuho ang Kasuduaan} %IV
...
\pagebreak
\chapter{Paglaban ni Diomedes sa mga Diyos} %V
...
\pagebreak
\chapter{Pagbalik ni Hector sa Troy} %VI
...
\pagebreak
\chapter{Duwelo ni Ajax at Hector} %VII
...
\pagebreak
\chapter{Pag-ikot ng Laban} %VIII
...
\pagebreak
\chapter{Ang Embahada kay Achilles} %IX
...
\chapter{Pagtingkayad sa Gabi} %X
